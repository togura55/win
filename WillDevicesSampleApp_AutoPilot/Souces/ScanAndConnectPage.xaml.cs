...
namespace WillDevicesSampleApp
{
    public sealed partial class ScanAndConnectPage : Page
    {
        ...
        {
            AppProber.WriteLog("Pressed [Connect] button");
 ...
 //           int index = listView.SelectedIndex;
            ...
            catch (Exception ex)
            {
                ...
                AppProber.WriteLog(sb.ToString());  // Auto pilot
            ...
            if (device == null)
            {
                ...
                AppProber.WriteLog("CreateDeviceAsync returns null");  // Auto pilot
                return;
            }
            ...
            AppProber.WriteLog("Device connection completed");  // Auto pilot
        }
