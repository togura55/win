	...
	CCreateContext* pContext)
{
	...
	if (m_wndSplitter.CreateStatic(this,3,1))
	{
		...
		size.cy-=430;
		if (m_wndSplitter.CreateView(0,0,RUNTIME_CLASS(CInputView),size,pContext))
		{
			if (!m_wndSplitter.CreateView(1,0,RUNTIME_CLASS(CRecListView),CSize(0,230),pContext))
			{
				return FALSE;
			}
