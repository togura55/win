================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: InsIndex プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した InsIndex には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには InsIndex アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
InsIndex.h
   ...
   CInsIndexApp アプリケーション クラスを宣言します。

InsIndex.cpp
   これは、アプリケーション クラス CInsIndexApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\InsIndex.ico
   ...
   アイコンはメイン リソース ファイル InsIndex.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、InsIndex.rc ファイル内
...
InsIndexDoc.h, InsIndexDoc.cpp - ドキュメント
   これらのファイルは CInsIndexDoc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CInsIndexDoc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

InsIndexView.h, InsIndexView.cpp - ドキュメントのビュー
   これらのファイルは CInsIndexView クラスを含みます。
   CInsIndexView オブジェクトは CInsIndexDoc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   InsIndex.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
